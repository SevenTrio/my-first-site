		...
		<div class="page__content">
			...
			<div class="not-found">
				<div class="not-found__container">
					<div class="not-found__title">404<img class="not-found__image" src="/images/dest/not-found.png" alt="Not Found"></div>
					<div class="not-found__subtitle"><?php echo _('cтраница</br>не найдена') ?></div>
				</div>
			</div>
