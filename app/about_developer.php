...
<body class="page page-about-developer">
	<div class="page__wrapper">
		<div class="page__content">
			...
			<div class="about-developer">
				<div class="about-developer__wrapper">
					<div class="about-developer__container">
						<div class="about-developer__foto">
							<img class="about-developer__image" src="/images/dest/foto.jpg" alt="Фото автора">
						</div>
						<div class="about-developer__content">
							<h1 class="about-developer__headline"><?php echo _('Привет, меня зовут Дмитрий и я начинающий фронтенд разработчик!'); ?></h1>
							<p class="about-developer__text"><?php echo _('В данный момент я обучаюсь в Днепропетровском национальном университете железнодорожного транстпорта (ДНУЖТ), на специальностии "Компьютерная Инженерия"!'); ?></p>
							<p class="about-developer__text"><?php echo _('Интересуюсь разработкой сайтов, созданием различных ботов и приложений, немного веб-дизайном. В своих работах пишу только валидный, кроссбраузерный и адаптивный код с использованием БЭМ методологии. Также имею небольшой опыт работы в node.js.'); ?></p>
						</div>
					</div>
				</div>
			</div>
