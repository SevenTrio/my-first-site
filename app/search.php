...
<body class="page page-search">
	<div class="page__wrapper">
		<div class="page__content">
			...
			<div class="page-search__search-form search-form">
				<form action="search" method="get" class="search-form__form">
					<div class="search-form__field-wrapper search-form__field-wrapper_type_from">
						...
						<input class="search-form__field" id="from" name="from" type="text" value="<?php echo($_GET['from']); ?>">
					...
					<div class="search-form__field-wrapper search-form__field-wrapper_type_to">
						...
						<input class="search-form__field" id="to" type="text" name="to" value="<?php echo($_GET['to']); ?>">
					</div>
					<div class="search-form__field-wrapper search-form__field-wrapper_type_date">
						...
						<input class="search-form__field" id="date" type="text" name="date" value="<?php echo($_GET['date']); ?>" readonly>
			...
			<div class="search-result">
				<div class="search-result__empty result-empty">
					<div class="result-empty__icon"></div>
					<div class="result-empty__text">
						<div class="result-empty__title"><?php echo _('Билеты не найдены');?></div>
						<div class="result-empty__subtitle"><?php echo _('Мы не нашли билеты на выбранную дату. Попробуйте поискать билеты на более позднюю или более раннюю дату.');?></div>
					</div>
				</div>
			</div>
