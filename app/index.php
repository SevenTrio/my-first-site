	...
	<div class="page__wrapper">
		<div class="page__content">
			<header class="header header_home">
				...
				<div class="header__upper header-upper header-upper_home">
				...
				<div class="hamburger-menu">
			 	...
			 	<div class="header__wrapper">
					<div class="header__motto header-motto">
						<div class="header-motto__wrapper">
							<h1 class="header-motto__text"><?php echo _('Легко запомнить. Просто купить.'); ?></h1>
						</div>
					</div>
					
					<div class="header__search-form search-form">
						<form action="search" method="get" class="search-form__form">
							<div class="search-form__field-wrapper search-form__field-wrapper_type_from">
								<label for="from" class="search-form__label"><?php echo _('Откуда'); ?></label>
								<input class="search-form__field" id="from" name="from" type="text" value="Одесса">
								<div class="search-form__reverse-button search-form__reverse-button_rotate"></div>
							</div>
							<div class="search-form__field-wrapper search-form__field-wrapper_type_to">
								<label for="to" class="search-form__label"><?php echo _('Куда'); ?></label>
								<input class="search-form__field" id="to" type="text" name="to" value="Киев">
							</div>
							<div class="search-form__field-wrapper search-form__field-wrapper_type_date">
								<label for="date" class="search-form__label"><?php echo _('Дата'); ?></label>
								<input class="search-form__field" id="date" type="text" name="date" value="<?php echo(date('d.m.Y')); ?>"  readonly>
								<div class="search-form__calendar-button"></div>
							</div>
							<div class="search-form__button-wrapper"><input type=submit value="<?php echo _('Найти билеты'); ?>" class="search-form__button button"></div>
						</form>
					</div>
				</div>
				...
				<div class="advantages__wrapper">
					<div class="advantages__container">
						<div class="advantages__item advantages-item">
							<div class="advantages-item__picture advantages-item__picture_bus"></div>
							<div class="advantages-item__text">
								<div class="advantages-item__title"><?php echo _('Легальные перевозчики'); ?></div>
								<div class="advantages-item__description"><?php echo _('Продаем билеты только на регулярные рейсы легальных перевозчиков'); ?></div>
							</div>
						</div>
						<div class="advantages__item advantages-item">
							<div class="advantages-item__picture advantages-item__picture_map-marker"></div>
							<div class="advantages-item__text">
								<div class="advantages-item__title"><?php echo _('Отправление с автостанций'); ?></div>
								<div class="advantages-item__description"><?php echo _('Вы гарантированно совершите свою поездку с посадкой на автостанции'); ?></div>
							</div>
						</div>
						<div class="advantages__item advantages-item">
							<div class="advantages-item__picture advantages-item__picture_wallet"></div>
							<div class="advantages-item__text">
								<div class="advantages-item__title"><?php echo _('Цена без скрытых платежей'); ?></div>
								<div class="advantages-item__description"><?php echo _('Налоги, сборы автостанций, комиссии - все включено'); ?></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="gallery">
				<div class="gallery__wrapper">
					<div class="gallery__container">
						<div class="gallery__heading-text"><?php echo _('Популярные маршруты'); ?></div>
					</div>
				</div>
				...
				<div class="gallery__wrapper">
					<div class="gallery__container">
						...
						<div class="gallery__item gallery__item_first gallery-item">
							<a href="<?php echo($prefix . '/search?from=Днепропетровск&to=Киев&date=' . date('d.m.Y')) ?>" class="gallery-item__container gallery-item__container_first">
								<img src="/images/dest/img-1.jpg" alt="<?php echo _('Днепропетровск - Киев'); ?>" class="gallery-item__image gallery-item__image_first">
								<div class="gallery-item__text"><?php echo _('Днепропетровск - Киев'); ?></div>
							</a>
						</div>
						
						<div class="gallery__item gallery-item">
							<a href="<?php echo($prefix . '/search?from=Николаев&to=Одесса&date=' . date('d.m.Y')) ?>" class="gallery-item__container">
								<img src="/images/dest/img-2.jpg" alt="<?php echo _('Николаев - Одесса'); ?>" class="gallery-item__image">
								<div class="gallery-item__text"><?php echo _('Николаев - Одесса'); ?></div>
							</a>
						</div>
						
						<div class="gallery__item gallery-item">
							<a href="<?php echo($prefix . '/search?from=Тернополь&to=Хмельницкий&date=' . date('d.m.Y')) ?>" class="gallery-item__container">
								<img src="/images/dest/img-3.jpg" alt="<?php echo _('Тернополь - Хмельницкий'); ?>" class="gallery-item__image">
								<div class="gallery-item__text"><?php echo _('Тернополь - Хмельницкий'); ?></div>
							</a>
						</div>
						
						<div class="gallery__item gallery-item">
							<a href="<?php echo($prefix . '/search?from=Житомир&to=Львов&date=' . date('d.m.Y')) ?>" class="gallery-item__container">
								<img src="/images/dest/img-4.jpg" alt="<?php echo _('Житомир - Львов'); ?>" class="gallery-item__image">
								<div class="gallery-item__text"><?php echo _('Житомир - Львов'); ?></div>
							</a>
						</div>
						
						<div class="gallery__item gallery-item">
							<a href="<?php echo($prefix . '/search?from=Полтава&to=Харьков&date=' . date('d.m.Y')) ?>" class="gallery-item__container">
								<img src="/images/dest/img-5.jpg" alt="<?php echo _('Полтава - Харьков'); ?>" class="gallery-item__image">
								<div class="gallery-item__text"><?php echo _('Полтава - Харьков'); ?></div>
							</a>
						</div>
